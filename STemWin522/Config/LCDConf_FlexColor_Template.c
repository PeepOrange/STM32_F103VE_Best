...
//	Config.Orientation = GUI_MIRROR_Y|GUI_MIRROR_X;								// 竖屏
 Config.Orientation = GUI_SWAP_XY | GUI_MIRROR_Y;					    //  横屏		
  ...
  GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, GUIDRV_FLEXCOLOR_F66709, GUIDRV_FLEXCOLOR_M16C0B16);		// ԭGUIDRV_FLEXCOLOR_F66708
