...
#define OS_CFG_H
                                             ...
                                             /* ---------------------------- MISCELLANEOUS -------------------------- */
#define OS_CFG_APP_HOOKS_EN             0u   //使能/禁用钩子函数
#define OS_CFG_ARG_CHK_EN               0u   //使能/禁用参数检测
#define OS_CFG_CALLED_FROM_ISR_CHK_EN   0u   //使能/禁用检测中断中非法调用功能
#define OS_CFG_DBG_EN                   0u   //使能/禁用调试代码和变量                                     
#define OS_CFG_ISR_POST_DEFERRED_EN     0u   //使能/禁用中断延迟发布
#define OS_CFG_OBJ_TYPE_CHK_EN          0u   //使能/禁用对象类型检测            
